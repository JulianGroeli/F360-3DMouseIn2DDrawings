...
This project uses configuration files for the Spacemouse to send panning and zooming navigation commands to Fusion 360's 2D drawing mode. Since Fusion 360 doesn't have a published API for 2D drawings mode, these configuration files set up the SpaceMouse to emulate the pan and zoom commands from a regular 2D mouse.
